...
`
  ...
  🔴 หากต้องการทราบพื้นที่ที่ควบคุมสูงสุดและเข้มงวดพิมพ์ !super ⬅️
  🔴 หากต้องการทราบพื้นที่ควบคุมสูงสุดพิมพ์ !danger ⬅️
  🔴 หากต้องการทราบพื้นที่ควบคุมให้พิมพ์  !normal   ⬅️` )
  
else if (message.content === '!super'){
    
    var Reply_SPred = `
📅 พื้นที่ควบคุมอัพเดตเมื่อวันที่ 
${redzone.data["update_date"]}

พื้นที่ควบคุมสูงสุดและเข้มงวด 
${redzone.data["พื้นที่ควบคุมสูงสุดและเข้มงวด"]}
...
พื้นที่ควบคุมสูงสุด 
${redzone.data["พื้นที่ควบคุมสูงสุด"]}
    `
message.reply(`${Reply_SNred}`);
    ...
    var Reply_Nred = `
📅 พื้นที่ควบคุมอัพเดตเมื่อวันที่ ${redzone.data["update_date"]}
